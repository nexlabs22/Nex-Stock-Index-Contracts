...
contract MockApiOracle is ChainlinkRequestInterface, LinkTokenReceiver {
  ...
  function fulfillOracleFundingRateRequest(bytes32 _requestId, address[] memory _tokens, uint256[] memory _marketCapShares)
    external
    ...
    returns (bool)
  {
    ...
    (bool success, ) = req.callbackAddr.call(
      ...
      abi.encodeWithSelector(req.callbackFunctionId, _requestId, _tokens, _marketCapShares)
